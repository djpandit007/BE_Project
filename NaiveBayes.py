...
print str(words.posts.count()) + " words loaded"
print str(users.posts.count()) + " user(s) present"
...
def trainData(username):
	...
	with warnings.catch_warnings():
		...
		for data in testData:
			...
			classWord = result.posts.update({'username' : 'pandit'}, {'$set' : {testWord : wordClass}}, upsert = True)